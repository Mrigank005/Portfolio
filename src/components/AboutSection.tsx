            ...
            <div className="cosmic-card p-6 h-full">
              <CardContent className="space-y-4">
                <p className="text-lg text-white/90">
                  I’m building my skills across AI, full-stack development, and product thinking — with a dream to launch my own startup by year three. 
                </p>
                <p className="text-lg text-white/80">
                  Curious by nature and caffeinated by choice ☕, I love turning ideas into scalable, meaningful solutions. Let’s innovate something amazing!
                </p>
